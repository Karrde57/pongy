...
public class GameManager extends StateBasedGame
{
	 ...
	 public static void main(String[] args) throws SlickException
	{
		 ...
		 container.setDisplayMode(Integer.parseInt(_options.get("window_size_x")), Integer.parseInt(_options.get("window_size_y")), false); // fenêtre de 1280*768 fullscreen =false !! 
